...
function(sfml_add_library name)
    ...
    set_property(DIRECTORY "${SFML_SOURCE_DIR}" PROPERTY "SFML_${SFML_CURRENT_MODULE}_HAS_EXPORT" YES)
...
function(sfml_add_module module)
    ...
    if(${is_enabled})
        ...
        set(SFML_HAS_SKIPPED_MODULE YES PARENT_SCOPE)
        return()
    endif()
...
macro(sfml_define_src_inc_variables)
    set(inc "${SFML_SOURCE_DIR}/include/SFML/${SFML_CURRENT_MODULE}")
    set(src "${SFML_SOURCE_DIR}/src/SFML/${SFML_CURRENT_MODULE}")
endmacro()
